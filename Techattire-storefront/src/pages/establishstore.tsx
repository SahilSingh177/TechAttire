  ...
  return (
      ...
      <div
        ...
        <div className="flex flex-col justify-between">
          <div>
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight">Lets make our family big!</h2>
            <div className="text-gray-700 mt-8">
              Hate forms? Send us an<a href="mailto:techattire@gmail.com"> <span className="underline">email</span></a> instead.
            </div>
          </div>
        ...
        <div className="">
          ...
          <div className="mt-8">
            <span className="uppercase text-sm text-gray-600 font-bold">Why do you want to establish a store here ?</span>
            <textarea
            ...
            <button
              ...
              Send Request
                  ...
                  <div id="toast-simple" className="flex items-center p-4 space-x-4 w-full max-w-xs text-gray-500 bg-white rounded-lg divide-x divide-gray-200 shadow dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert" style={{display:"none"}}>
                    ...
                    <div className="pl-4 text-sm font-normal">Message sent successfully.</div></div>
              </div>
