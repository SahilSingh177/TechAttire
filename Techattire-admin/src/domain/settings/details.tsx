      ...
      <div className="max-w-[632px]">
        ...
        >
          ...
          <Input
            ...
            placeholder="https://TechAttire.inc/swap={swap_id}"
          />
          <Input
            className="mt-base"
            label="Draft order link template"
            {...register("payment_link_template")}
            placeholder="https://TechAttire.inc/payment={payment_id}"
          />
          <Input
            className="mt-base"
            label="Invite link template"
            {...register("invite_link_template")}
            placeholder="https://TechAttire-admin.inc/invite?token={invite_token}"
          />
        </BodyCard>
      </div>
    </form>
